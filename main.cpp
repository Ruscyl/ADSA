...
string kratsuba(string first_num, string second_num, int base)
{
...
int main()
{
	...
	cout << school_method_addition(first_num, second_num, base_int)<<" "<<kratsuba(first_num, second_num, base_int)<<endl;
	return 0;
}
